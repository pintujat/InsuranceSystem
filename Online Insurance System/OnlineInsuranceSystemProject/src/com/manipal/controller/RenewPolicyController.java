 ...
 */
//@WebServlet("/RenewPolicyController")
public class RenewPolicyController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		long oldpolicyid=Long.parseLong(request.getParameter("t2"));
		String renewdate=request.getParameter("t3");
		...
		try
		{
			...
			int check=(RenewPolicyservice.renewPolicy( oldpolicyid, renewdate));
