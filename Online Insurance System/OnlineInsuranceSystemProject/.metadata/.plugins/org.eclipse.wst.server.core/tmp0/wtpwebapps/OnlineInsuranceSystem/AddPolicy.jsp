...
Policy id:		    <input type="text" name="t1"  required=""></br></br>
 -->
Insurance id:	    <input type="number" name="t2" required=""></br></br>
...
Agent id:		    <input type="number" name="t7" required=""></br></br>

User id:		    <input type="number" name="t8" required=""></br></br>
