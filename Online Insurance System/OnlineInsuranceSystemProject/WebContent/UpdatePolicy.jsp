...
Policy a=new Policy(); %>
Policy Id  <input type="text" value="<%= request.getParameter("x") %>">

Insurance id:		<input type="number" name="t2" value="<%= request.getParameter("a") %>"readonly="readonly">
...
Agent id:		 <input type="text" value="<%= request.getParameter("y") %>">

User id:		 <input type="text" value="<%= request.getParameter("z") %>">
