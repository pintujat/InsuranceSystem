...
Agent Id  <input type="number" name="can_id" value="<%= request.getParameter("x") %>" readonly="readonly"/>
...
PanNo:     <input type="text" name="t5" value="<%= request.getParameter("d")%>"  required=""><br>
Salary:    <input type="number" name="t6"  value="<%= request.getParameter("e")%>" required="" ><br>
