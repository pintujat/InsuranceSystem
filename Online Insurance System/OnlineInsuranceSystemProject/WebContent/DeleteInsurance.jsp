...
<div class="row header">
    ...
    <form method="post" action="InsuranceDeleteController">
 <ul>
  <li>
  
  <% InsuranceService c=new InsuranceServiceImpl();
		InsuranceModel a=new InsuranceModel(); %><br><br>
		
Insurance Id  <input type="number" name="insuranceId" value="<%= request.getParameter("x") %>"/>
